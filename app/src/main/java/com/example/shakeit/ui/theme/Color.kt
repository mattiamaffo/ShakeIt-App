...
// Colors for the app's elements
val Purple1 = Color(0xFF7158E2)
val LightBlue1 = Color(0xFF32F1FF)
val Yellow1 = Color(0xFFE79B02)
val Yellow2 = Color(0xFFFFD438)
val Purple2 = Color(0xFF313044)
